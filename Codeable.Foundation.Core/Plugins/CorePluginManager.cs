...
{
    public partial class CorePluginManager : ChokeableClass, IPluginManager, IDisposable
    {
        #region Constructor
        ...
        public virtual void LoadAllPlugins()
        {
            ...
            {
                IFindClassTypes finder = IFoundation.Container.Resolve<IFindClassTypes>();
        ...
        public virtual bool UnRegisterFoundationPlugin(string displayName)
        {
            ...
            {
                IFoundationPlugin iPlugin = FoundationPlugins.First(p => p.DisplayName.Equals(displayName, StringComparison.OrdinalIgnoreCase));
